...
public final class PowerManagerService extends SystemService
    ...
    private void notifyWakeLockAcquiredLocked(WakeLock wakeLock) {
        if (mSystemReady && !wakeLock.mDisabled) {
            FrankensteinFrameworkHooks.wakeLock(
                    wakeLock.mOwnerUid, wakeLock.mOwnerPid, wakeLock.mTag,
                    wakeLock.mFlags & PowerManager.WAKE_LOCK_LEVEL_MASK,
                    true, RELEASE_REASON_NOT_ACQUIRED);
    ...
    void setWakefulnessLocked(int groupId, int wakefulness, long eventTime, int uid, int reason,
        ...
        FrankensteinFrameworkHooks.wakefulness(uid, groupId, wakefulness, reason);
